        ...
        child: Stack(
          children: <Widget>[
            Column(
              children: [
                Container(
                    margin: const EdgeInsets.all(20).add(EdgeInsets.only(top: height * 0.10)),
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child: Padding(
                      padding: const EdgeInsets.all(8.0).add(EdgeInsets.only(top: height * 0.25)),
                        ...
                        return Form(
                          ...
                          child: Column(
                            children: [
                              ...
                              Padding(
                                padding: const EdgeInsets.only(top: 40, left: 20.0, right: 40),
                                child: TextFormField(
                                  style: const TextStyle(color: Colors.white, fontFamily: 'UniNeue'),
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'Password',
                                    hintStyle: const TextStyle(color: Colors.white70, fontFamily: 'UniNeue'),
                              ...
                              Padding(
                                padding: const EdgeInsets.only(top: 40, left: 20.0, right: 40),
                                child: TextFormField(
                                  style: const TextStyle(color: Colors.white, fontFamily: 'UniNeue', fontSize: 18),
                                  keyboardType: TextInputType.text,
                                  //   validator: (val) => confirmPassword(pwdController.text, val),
                              ...
                              Row(
                                ...
                                children: [
                                  const Text(
                                    ...
                                    style: TextStyle(color: Colors.white, fontSize: 18, fontFamily: 'UniNeue'),
                                  ),
                                  const SizedBox(
                                    width: 10,
                                  ),
