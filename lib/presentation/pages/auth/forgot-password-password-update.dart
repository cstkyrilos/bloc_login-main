      ...
      builder: (context, state) {
        return Scaffold(
            appBar: AppBar(
              ...
              centerTitle: true,
              title: const Text("Reset your Password", style: TextStyle(fontFamily: 'UniNeue', color: Colors.white)),
            ),
            body: Column(
              ...
              children: [
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: const DecorationImage(
                            image: NetworkImage("https://velocityhealth.co.za/assets/images/icons/logo.png"),
                            fit: BoxFit.fill,
                          ),
                          border: Border.all(
                      ...
                      Column(
                        ...
                        children: <Widget>[
                          ...
                          Text(
                            (state as Authsendcode).props[0].toString(),
                            style: TextStyle(
                              color: Color(0xFF0093CD),
                              fontSize: 13.0,
                              fontFamily: 'UniNeue',
                ...
                const Padding(
                  ...
                  child: Text("Strong password contains numbers, letters and punctuation marks",
                      textAlign: TextAlign.center, style: TextStyle(color: Color(0xFF0093CD), fontSize: 20, fontFamily: 'UniNeue')),
                ),
                Expanded(
                    ...
                    child: Column(
                      children: [
                        Padding(
                          ...
                          child: TextFormField(
                            style: const TextStyle(color: Color(0xFF0093CD), fontFamily: 'UniNeue'),
                            validator: (val) {
                              return null;
                            },
                            ...
                            decoration: InputDecoration(
                              ...
                              hintStyle: const TextStyle(color: Color(0xFF0093CD), fontFamily: 'UniNeue'),
                              enabledBorder: const UnderlineInputBorder(
                                borderSide: BorderSide(color: const Color(0xffff026c93)),
                              ),
                        ...
                        Padding(
                          padding: const EdgeInsets.only(left: 20.0, right: 40, top: 50),
                          child: TextFormField(
                            style: const TextStyle(color: Color(0xFF0093CD), fontFamily: 'UniNeue'),
                            validator: (val) {
                              return null;
                        ...
                        Padding(
                          ...
                          child: ElevatedButton(
                              style: ElevatedButton.styleFrom(
                                ...
                                side: const BorderSide(color: Color(0xFF0093CD), width: 1),
                                shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(30)),
                              ),
                              onPressed: () {
                                if (validateForm() && state is Authsendcode) {
                                  BlocProvider.of<AuthBloc>(context)
                                      .add(AuthResetpasswordRequested((state as Authsendcode).props[0].toString(), pwdController.text));
                                }
                              },
                              child: const Text(
                                'Reset Password',
                                style: TextStyle(color: Colors.white, fontSize: 20, fontFamily: 'UniNeue'),
                              )),
                        ),
                      ],
                    ),
